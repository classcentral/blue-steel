...
<meta itemprop="author" content = "Prakhar Srivastav"/>
<meta itemprop="name" content="Course Review: Mining Massive Datasets, offered by Stanford on Coursera">
...
<div class="reviewWidget_header">
    <span class="reviewWidget_title" itemprop="about">Mining Massive Datasets</span>
</div>
...
<div class="reviewWidget_body">
    <div class="reviewWidget_info">
        ...
        <div class="reviewWidget_info_block reviewWidget_info_block-institution">
            ...
            <div class="reviewWidget_info_text">Stanford</div>
        </div>
        <div class="reviewWidget_info_block reviewWidget_info_block-duration">
            ...
            <div class="reviewWidget_info_text">7 weeks</div>
        </div>
        <div class="reviewWidget_info_block reviewWidget_info_block-intensity">
            ...
            <div class="reviewWidget_info_text">6-8 hours/week</div>
        </div>
...
<div class="reviewWidget_footer">
    ...
    <div class="reviewWidget_footer_communityRating">
        ...
        <div class="starRating rating40 starRating-small starRating-gray">
            <div class="starRating_star">
                <svg class="starRating_starShape starRating_starShape-blank">
                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#shape-star-full"></use>
                </svg>
        ...
        <a href="https://www.class-central.com/mooc/2406/coursera-mining-massive-datasets#course-all-reviews" class="number-of-ratings-bubble">2</a>
    </div>

    <a href="https://www.coursera.org/course/mmds" target="_blank" class="reviewWidget_footer_button">Go To Class</a>
</div>
</div>
</div>
...
<!-- review widget end -->
<p>
    <i><b>Editors Note</b>: Review by <a href="http://prakhar.me/">Prakhar Srivastav</a>. Prakhar loves building things (mostly for the web) and celebrating the joy of programming. In his free time he enjoys gaming, doing courses and trying out new programming languages. <a href="https://www.class-central.com/@prakhar">Prakhar's transcript</a></i>
</p>
