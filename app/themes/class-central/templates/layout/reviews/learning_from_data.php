  ...
  <div class="reviewWidget">
    ...
    <div class="reviewWidget_body">
      <div class="reviewWidget_info">
        <div class="reviewWidget_info_block reviewWidget_info_block-provider">
          ...
          <div class="reviewWidget_info_text">edX</div>
        </div>
        <div class="reviewWidget_info_block reviewWidget_info_block-institution">
          ...
          <div class="reviewWidget_info_text">Caltech</div>
        </div>
        <div class="reviewWidget_info_block reviewWidget_info_block-duration">
          ...
          <div class="reviewWidget_info_text">10 wks</div>
        </div>
        <div class="reviewWidget_info_block reviewWidget_info_block-intensity">
          ...
          <div class="reviewWidget_info_text">10-20 hours/week</div>
        </div>
    ...
    <div class="reviewWidget_footer">
      ...
      <div class="reviewWidget_footer_communityRating">
        ...
        <a href="https://www.class-central.com/mooc/1240/edx-cs1156x-learning-from-data#course-all-reviews" class="number-of-ratings-bubble">5</a>
      </div>

      <a href="https://www.edx.org/course/learning-data-caltechx-cs1156x" target="_blank" class="reviewWidget_footer_button">Go To Class</a>
    </div>
  </div>
</div>
