...
<meta itemprop="author" content = "Ken Sellers"/>
<meta itemprop="name" content="Course Review: Bioinformatics Algorithms (Part 1) offered by UC San Diego on Coursera">
...
<div class="reviewWidget_header">
    <span class="reviewWidget_title" itemprop="about">Bioinformatics Algorithms (Part 1)</span>
</div>
...
<div class="reviewWidget_body">
    <div class="reviewWidget_info">
        ...
        <div class="reviewWidget_info_block reviewWidget_info_block-institution">
            ...
            <div class="reviewWidget_info_text">UC San Diego</div>
        </div>
        <div class="reviewWidget_info_block reviewWidget_info_block-duration">
            ...
            <div class="reviewWidget_info_text">10 weeks</div>
        </div>
        <div class="reviewWidget_info_block reviewWidget_info_block-intensity">
            ...
            <div class="reviewWidget_info_text">20 hours/week</div>
        </div>
    ...
    <div class="reviewWidget_text"  itemprop="description">
        A difficult but satisfying journey that blends biology, programming and algorithmic principles to analyze DNA and amino acid sequences. Learners have the choice of consuming material thru video lectures or interactive text.
    </div>
</div>
...
<div class="reviewWidget_footer">
    ...
    <div class="reviewWidget_footer_communityRating">
        ...
        <div class="starRating rating50 starRating-small starRating-gray">
            <div class="starRating_star">
                <svg class="starRating_starShape starRating_starShape-blank">
                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#shape-star-full"></use>
                </svg>
        ...
        <a href="https://www.class-central.com/mooc/745/coursera-bioinformatics-algorithms-part-1#course-all-reviews" class="number-of-ratings-bubble">1</a>
    </div>

    <a href="https://www.coursera.org/course/bioinformatics" target="_blank" class="reviewWidget_footer_button">Go To Class</a>
</div>
</div>
</div>
