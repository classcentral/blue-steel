...
define( 'WP_HOME', 'https://ccdev.local/report' );
define( 'WP_SITEURL', 'https://ccdev.local/report/wordpress' );
define( 'WP_CONTENT_DIR', '/usr/share/nginx/wp-blog/report/app' );
define( 'WP_CONTENT_URL', 'https://ccdev.local/report/app' );
